...
- **Run ID:** 20260724_170359
- **Output:** `<repo-root>\artifacts\discovery_smoke_20260724_170359`
...
## Imputation
- **KNN(k=5,dist)**: RMSE=1.9504±0.1836, MAE=1.3336±0.1341, corr_RV=0.9943±0.0018, corr_Frel=0.1073
- **MissForest**: RMSE=1.8115±0.1767, MAE=1.2368±0.1263, corr_RV=0.9951±0.0019, corr_Frel=0.0995
- **RFECA_SVR(k=5)**: RMSE=1.9528±0.2449, MAE=1.3143±0.1431, corr_RV=0.9943±0.0016, corr_Frel=0.1077
- **SimpleMean**: RMSE=2.7897±0.3075, MAE=2.0483±0.2085, corr_RV=0.9882±0.0022, corr_Frel=0.1637

## Classification (EnsembleSoft)
- **KNN(k=5,dist)**: F1=0.9236±0.0409, BalAcc=0.9103±0.0477
- **MissForest**: F1=0.9229±0.0396, BalAcc=0.9081±0.0429
